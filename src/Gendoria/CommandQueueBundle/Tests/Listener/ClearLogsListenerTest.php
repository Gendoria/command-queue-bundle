...
use Gendoria\CommandQueueBundle\Listener\ClearLogsListener;
...
class ClearLogsListenerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getEventData()
    {
        ...
        return array(
            array(new QueueBeforeTranslateEvent($worker, "ttt", self::SUBSYSTEM_NAME), "beforeQueueRun", true),
            
            array(new QueueProcessEvent($worker, $command, $processor, self::SUBSYSTEM_NAME), "afterQueueRun", true),
        );
    }
}
