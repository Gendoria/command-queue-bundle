...
namespace Gendoria\CommandQueueBundle\Tests\Listener;
...
use Gendoria\CommandQueueBundle\Listener\ClearEntityManagersListener;
...
class ClearEntityManagersListenerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getEventData()
    {
        ...
        return array(
            array(new QueueBeforeTranslateEvent($worker, "ttt", self::SUBSYSTEM_NAME), "beforeQueueRun", $this->getEventDataCreateManagers(0), true),
            array(new QueueBeforeTranslateEvent($worker, "ttt", self::SUBSYSTEM_NAME), "beforeQueueRun", $this->getEventDataCreateManagers(4), true),
            
            array(new QueueProcessEvent($worker, $command, $processor, self::SUBSYSTEM_NAME), "afterQueueRun", $this->getEventDataCreateManagers(0), true),
            array(new QueueProcessEvent($worker, $command, $processor, self::SUBSYSTEM_NAME), "afterQueueRun", $this->getEventDataCreateManagers(4), true),
        );
    }
